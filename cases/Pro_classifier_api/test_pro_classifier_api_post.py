...
print("这是pro_classifier_api的test")
@pytest.mark.parametrize('url',["qz668.com"])
def test_pro_classifier_api_post(url):
    # count = 0
    ...
    #     print('开始执行第:', count, line)
        ...
        response = requests.post("http://127.0.0.1:8009/apis/pro_classifier_api",
                                 headers=headers,
