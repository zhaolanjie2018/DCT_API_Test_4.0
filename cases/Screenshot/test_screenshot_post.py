...
print("这是Screenshot的test")
@pytest.mark.parametrize('url',['http://www.yinfans.me/'])
def test_Screenshot_post(url):
    # count = 0
    ...
    #     print('开始执行第:', count, line)
        ...
        response = requests.post("http://127.0.0.1:8009/apis/Screenshot",
                                 headers=headers,
