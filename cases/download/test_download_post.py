...
print("这是download的test")
@pytest.mark.parametrize('url',['http://www.yinfans.me/movie/20332'])
def test_language_post(url):
        print(url)
    # count = 0
    ...
    #     print('开始执行第:', count, line)
        ...
        response = requests.post("http://127.0.0.1:8009/apis/Download",
                                 headers=headers,
